...
START_MEDIA_TYPE = "video"  # Yahan likho "image" ya "video" ya "none" (agar kuch nahi chahiye)
...
START_VIDEO_URL = "https://files.catbox.moe/7pifzq.mp4"  # Apni video ka direct mp4 link
