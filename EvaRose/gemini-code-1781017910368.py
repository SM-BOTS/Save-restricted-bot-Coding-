...
async def send_start(client: Client, message: Message):
    ...
    # 🌟 PREMIUM STYLIZED START BUTTONS
    buttons = [
...
async def settings_cmd(client, message):
    ...
    buttons = [
        [InlineKeyboardButton("🔑 𝐋𝐎𝐆𝐈𝐍 𝐀𝐂𝐂𝐎𝐔𝐍𝐓", callback_data="req_login"), InlineKeyboardButton("🚪 𝐋𝐎𝐆𝐎𝐔𝐓 𝐒𝐄𝐒𝐒𝐈𝐎𝐍", callback_data="req_logout")],
        [InlineKeyboardButton("⚙️ 𝐒𝐄𝐓 𝐃𝐔𝐌𝐏", callback_data="set_dump_info"), InlineKeyboardButton("❌ 𝐑𝐄𝐌𝐎𝐕𝐄 𝐃𝐔𝐌𝐏", callback_data="rem_dump")],
        [InlineKeyboardButton("✍️ 𝐒𝐄𝐓 𝐂𝐀𝐏𝐓𝐈𝐎𝐍", callback_data="set_caption_info"), InlineKeyboardButton("🗑️ 𝐑𝐄𝐌𝐎𝐕𝐄 𝐂𝐀𝐏𝐓𝐈𝐎𝐍", callback_data="rem_caption")],
        [InlineKeyboardButton("🖼️ 𝐒𝐄𝐓 𝐓𝐇𝐔𝐌𝐁𝐍𝐀𝐈𝐋", callback_data="set_thumb_info"), InlineKeyboardButton("🗑️ 𝐑𝐄𝐌𝐎𝐕𝐄 𝐓𝐇𝐔𝐌𝐁", callback_data="rem_thumb")],
...
async def logout_click_callback(client, callback_query):
    ...
    back_btn = [[InlineKeyboardButton("🔙 𝐁𝐀𝐂𝐊 𝐓𝐎 𝐒𝐄𝐓𝐓𝐈𝐍𝐆𝐒", callback_data="settings_cmd")]]
...
async def back_to_main_start_callback(client, callback_query):
    ...
    # 🌟 MAIN START BUTTONS ALSO CONVERTED TO MATCH THE PREMIUM LAYOUT FONT
    buttons = [
        [InlineKeyboardButton("❣️ 𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑", url="https://t.me/kingvj01")],
        [InlineKeyboardButton("🔍 𝐒𝐔𝐏𝐏𝐎𝐑𝐓 𝐆𝐑𝐎𝐔𝐏", url="https://t.me/vj_bot_disscussion"), InlineKeyboardButton("🤖 𝐔block 𝐂𝐇𝐀block𝐄𝐋", url="https://t.me/vj_bots")],
        [InlineKeyboardButton("⚙️ 𝐁𝐎𝐓 𝐒𝐄𝐓𝐓𝐈𝐍𝐆𝐒", callback_data="settings_cmd")]
    ]
