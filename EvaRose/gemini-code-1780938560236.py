...
async def set_caption_callback(client, callback_query):
    ...
    try:
        ...
        if response and response.text:
            ...
            await response.reply_text("Caption updated.")
    except Exception as e: await client.send_message(callback_query.from_user.id, f"Error: {e}")
...
async def remove_caption_callback(client, callback_query):
    ...
    await callback_query.message.edit_text("Custom caption removed.")
...
async def set_thumbnail_callback(client, callback_query):
    ...
    try:
        ...
        if response and response.photo:
            ...
            await response.reply_text("🟢 **Custom thumbnail locked.**")
        else: await client.send_message(callback_query.from_user.id, "❌ **Failed:** Send an image file.")
    except Exception as e: await client.send_message(callback_query.from_user.id, f"Error: {e}")
...
async def remove_thumbnail_callback(client, callback_query):
    ...
    await callback_query.message.edit_text("🔴 **Custom thumbnail removed.**")