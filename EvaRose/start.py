...
async def send_start(client: Client, message: Message):
    ...
    # START MENU BUTTONS (NORMAL FONT)
    buttons = [
    ...
    # 📝 DIRECT TEXT ONLY (IMAGE CODE REMOVED PERMANENTLY)
    await client.send_message(chat_id=message.chat.id, text=text, reply_markup=InlineKeyboardMarkup(buttons), reply_to_message_id=message.id, parse_mode=enums.ParseMode.HTML)
