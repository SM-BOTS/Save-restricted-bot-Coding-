...
async def send_start(client: Client, message: Message):
    ...
    buttons = [
        ...
        [InlineKeyboardButton("🔍 𝐒𝐔𝐏𝐏𝐎𝐑𝐓 𝐆𝐑𝐎𝐔𝐏", url="https://t.me/vj_bot_disscussion"), InlineKeyboardButton("🤖 𝐔𝐏𝐃𝐀𝐓𝐄 𝐂𝐇𝐀𝐍𝐍𝐄𝐋", url="https://t.me/vj_bots")],
...
async def settings_cmd(client, message):
    ...
    buttons = [
        [InlineKeyboardButton("🔑 𝐋𝐎𝐆𝐈𝐍 𝐀🇨🇨𝐎𝐔𝐍𝐓", callback_data="req_login"), InlineKeyboardButton("🚪 𝐋𝐎𝐆𝐎𝐔𝐓 𝐒𝐄𝐒𝐒𝐈𝐎𝐍", callback_data="req_logout")],
        [InlineKeyboardButton("⚙️ 𝐒𝐄𝐓 𝐃𝐔𝐌𝐏", callback_data="set_dump_info"), InlineKeyboardButton("❌ 𝐑𝐄𝐌𝐎𝐕block 𝐃𝐔𝐌𝐏", callback_data="rem_dump")],
        [InlineKeyboardButton("✍️ 𝐒𝐄𝐓 𝐂𝐀𝐏𝐓𝐈𝐎𝐍", callback_data="set_caption_info"), InlineKeyboardButton("🗑️ 𝐑block𝐌block𝐕block 𝐂𝐀𝐏...", callback_data="rem_caption")],
        [InlineKeyboardButton("🖼️ 𝐒𝐄𝐓 𝐓𝐇𝐔𝐌𝐁𝐍𝐀𝐈𝐋", callback_data="set_thumb_info"), InlineKeyboardButton("🗑️ 𝐑block𝐌block𝐕block 𝐓𝐇𝐔...", callback_data="rem_thumb")],
...
async def settings_callback(client, callback_query):
    ...
    buttons = [
        [InlineKeyboardButton("🔑 𝐋𝐎𝐆𝐈𝐍 𝐀🇨🇨𝐎𝐔𝐍𝐓", callback_data="req_login"), InlineKeyboardButton("🚪 𝐋𝐎𝐆𝐎𝐔𝐓 𝐒𝐄𝐒𝐒𝐈𝐎𝐍", callback_data="req_logout")],
        [InlineKeyboardButton("⚙️ 𝐒ZE𝐓 𝐃𝐔𝐌𝐏", callback_data="set_dump_info"), InlineKeyboardButton("❌ 𝐑𝐄𝐌𝐎𝐕block 𝐃𝐔𝐌𝐏", callback_data="rem_dump")],
        [InlineKeyboardButton("✍️ 𝐒𝐄𝐓 𝐂... ", callback_data="set_caption_info"), InlineKeyboardButton("🗑️ 𝐑block𝐌block... ", callback_data="rem_caption")],
        [InlineKeyboardButton("🖼️ 𝐒𝐄𝐓 𝐓𝐇𝐔𝐌𝐁𝐍𝐀𝐈𝐋", callback_data="set_thumb_info"), InlineKeyboardButton("🗑️ 𝐑block... ", callback_data="rem_thumb")],
        [InlineKeyboardButton("🔙 𝐁block🇨𝐊 𝐓block 𝐌block𝐍𝐔", callback_data="back_to_main_start")]
    ]
...
async def back_to_main_start_callback(client, callback_query):
    ...
    buttons = [
        [InlineKeyboardButton("❣️ 𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑", url="https://t.me/kingvj01")],
        [InlineKeyboardButton("🔍 𝐒𝐔𝐏𝐏𝐎𝐑𝐓 𝐆𝐑𝐎𝐔𝐏", url="https://t.me/vj_bot_disscussion"), InlineKeyboardButton("🤖 𝐔𝐏block 𝐂𝐇block𝐄𝐋", url="https://t.me/vj_bots")],
